...
export declare const initEditorSizingButton: ({ editor, initialHeight, minHeight, maxHeight, gapHeight, sizingButtonPosition, scrollElement }: EditorSizingButtonConfig) => void;
