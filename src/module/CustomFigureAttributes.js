 ...
 * @see https://ckeditor.com/docs/ckeditor5/latest/api/module_engine_model_schema-Schema.html#function-extend
 * https://ckeditor.com/docs/ckeditor5/latest/framework/deep-dive/schema.html#defining-additional-semantics
 */
class CustomFigureAttributes {
    ...
    afterInit() {
        ...
        setupCustomClassConversion( 'span', '$blockObject', editor );
